-- Query: List all shows from
--the hbtn_0d_tvshows database.
-- Each record should display: TV
--Show Title and Genre ID.
-- Results must be sorted in ascending
--order by TV Show Title and Genre ID.
-- If a show doesn’t have a genre, display NULL.
-- The database name "hbtn_0d_tvshows"
--will be passed as an argument of the mysql command.
