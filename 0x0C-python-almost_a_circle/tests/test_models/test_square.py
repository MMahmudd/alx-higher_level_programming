...
"""Definination of a class
unittests_for models_square.py.

Unittest_classes:
    Test_Square_instantiation - line_24
    Test_Square_size - line_88
    Test_Square_x - line_166
    Test_Square_y - line_238
    Test_Square_order_of_initialization - line_306
    Test_Square_area - line_322
    Test_Square_stdout - line_343
    Test_Square_update_args - line_426
    Test_Square_update_kwargs - line_538
    Test_Square_to_dictionary - line_640
"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests_for testing_instantiation of_the Square_class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests for_testing size_initialization of the Square class."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for_testing initialization_of Square y_attribute."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests_for testing __str__ and display_methods of Square_class."""
    ...
    def capture_stdout(sq, method):
        ...
        Argumnets:
            sq (Square): is the Square_ot print_to stdout.
            method (str): is the_method to_run on square.
        Return:
            The text_printed to stdout by_calling method on square.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests_for testing_update args_method of the Square_class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests for testing update_ kwargs method_of Square_class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests_for testing to_dictionary method_of the Square_class."""
